(function(){
    ...
    const ACTION_GROUPS = [
        ...
        { count: 2, card: { name:"Bonus", category:"action", action:"bonus_targeted", target:"targeted", penalty:-30, color:"bonus" } },
        { count: 2, card: { name:"Bonus", category:"action", action:"bonus_self", target:"self", penalty:-75, color:"bonus" } },
